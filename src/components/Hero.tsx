...
const Hero = () => {
    ...
    return (
          <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
            {/* Background Image */}
                <picture className="absolute inset-0">
                  ...
                  {/* Overlay pour améliorer la lisibilité du texte */}
                        <div className="absolute inset-0 bg-gradient-to-b from-background/40 via-background/50 to-background/90"></div>div>
                </picture>picture>
                        ...
                        <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8 animate-fade-in">
                                  ...
                                  <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center pt-4 md:pt-6">
                                              ...
                                              <Button
                                                              ...
                                                              asChild
                                                            >
                                                            <a href="https://app.programme-agp.fr" target="_blank" rel="noopener noreferrer">
                                  ...
                                  <div className="pt-8 md:pt-12 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
                                              <div className="space-y-1 md:space-y-2 animate-slide-up" style={{ animationDelay: "0.2s" }}>
                                                            <div className="text-2xl md:text-4xl font-bold text-primary">+1000</div>div>
                                                            <div className="text-xs md:text-base text-muted-foreground">Personnes accompagnées</div>div>
                                              </div>div>
                                              <div className="space-y-1 md:space-y-2 animate-slide-up" style={{ animationDelay: "0.3s" }}>
                                                            <div className="text-2xl md:text-4xl font-bold text-primary">+450</div>div>
                                                            <div className="text-xs md:text-base text-muted-foreground">Praticiens formés</div>div>
                                              </div>div>
                                              <div className="space-y-1 md:space-y-2 animate-slide-up" style={{ animationDelay: "0.4s" }}>
                                                            <div className="text-2xl md:text-4xl font-bold text-secondary">95%</div>div>
                                                            <div className="text-xs md:text-base text-muted-foreground">Taux de satisfaction</div>div>
                                              </div>div>
                                              <div className="space-y-1 md:space-y-2 animate-slide-up" style={{ animationDelay: "0.5s" }}>
                                                            <div className="text-2xl md:text-4xl font-bold text-primary">10+</div>div>
                                                            <div className="text-xs md:text-base text-muted-foreground">Années d'expérience</div>div>
                                              </div>div>
                                  </div>div>
                        </div>div>
                </div>div>
            ...
            {/* Decorative elements */}
                <div className="absolute top-20 right-10 w-72 h-72 bg-primary/5 rounded-full blur-3xl animate-float"></div>div>
                <div className="absolute bottom-20 left-10 w-96 h-96 bg-secondary/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }}></div>div>
          </section>section>
        );
};
